...
namespace figure
{
    ...
    public:
        virtual void start()
        {
            const auto asset_controller = nature_lab::asset_controller::instance();
            shader = asset_controller->get_shader("figure");
            projection = glxm::ortho(projection, 0.0f, nature_lab::asset_controller::screen_width,
                                     0.0f, nature_lab::asset_controller::screen_height, -0.01f, 1.0f);
        }
