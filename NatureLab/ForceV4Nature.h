...
namespace NatureLab {
    ...
    struct ForceV4System
    {
        ...
        inline void update(const int& _width, const int& _height, const float deltaTime, float m_limiteEdge = 0) {
    ...
    class ForceV4Nature : public INature, ITimeEvent {
    public:
        ...
        inline void update() override {
            ...
            for (const auto& it : m_natureSystem) {
                ...
                it->update(this->m_width, this->m_height, deltaTime, m_limiteEdge);
            }
        }
